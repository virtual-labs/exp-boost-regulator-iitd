const src = {
  ...
  set() {
    this.allItems = {
      ...
      btn_hint: this.allImgsDom[141],
      hint_box: this.allImgsDom[142],

      //experimental section images added
      beta_line_blinking: this.allImgsDom[143],
      bnt_click: this.allImgsDom[144],
      btn_firing_angle: this.allImgsDom[145],
      btn_input_voltage: this.allImgsDom[146],
      btn_load_inductance: this.allImgsDom[147],
      btn_load_resistance: this.allImgsDom[148],
      components_rl_load: this.allImgsDom[149],
      components_r_load: this.allImgsDom[150],
      rl_load_click_1: this.allImgsDom[151],
      rl_load_click_2: this.allImgsDom[152],
      rl_load_click_3: this.allImgsDom[153],
      rl_load_click_4: this.allImgsDom[154],
      r_load_click_1: this.allImgsDom[155],
      r_load_click_2: this.allImgsDom[156],
      r_load_click_3: this.allImgsDom[157],
      r_load_click_4: this.allImgsDom[158],
      val_a: this.allImgsDom[159],
      val_l: this.allImgsDom[160],
      val_r: this.allImgsDom[161],
      val_v: this.allImgsDom[162],
      circle: this.allImgsDom[163],
